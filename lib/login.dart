    ...
    Future<void> loginUser() async{
      ...
      try{
        ...
        http.Response response = await http.post(
          Uri.parse('https://sentesave.000webhostapp.com/api/login_account.php'),
          body: senddata,
        );
          ...
          Container(
            ...
            child: const Align(
              alignment: Alignment.center,
                child: Text('SenteSave',
                  style: TextStyle(color: Colors.teal, fontWeight: FontWeight.w800, fontSize:30.0),
                ),
              ),
          ),
          ...
          Container(
            ...
            child: ElevatedButton(
             ...
             backgroundColor: Colors.teal, ),
              child: Text('LOGIN', style: TextStyle(fontSize:15.0,color: Colors.white, fontWeight: FontWeight.w600),),
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Align(
                  ...
                  child: Text('Have no account?', style: TextStyle(fontSize:15.0, fontWeight: FontWeight.w700),),
                ),
              ),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Align(
                    ...
                    child: Text('Sign Up', style: TextStyle(fontSize:15.0,color: Colors.blue, fontWeight: FontWeight.w700), textAlign: TextAlign.right),
